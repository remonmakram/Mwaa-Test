...
/*and apo.ODS_CREATE_DATE >= TS.BEGIN_DATE and apo.ODS_CREATE_DATE <= TS.END_DATE*/
/*and apo.ODS_CREATE_DATE >= TS.BEGIN_DATE and apo.ODS_CREATE_DATE <= TS.END_DATE*/
...
select
    ...
    ,case 
        ...
        when apo.SCHOOL_YEAR <= 2016 and TS.END_DATE = to_date('20160624','YYYYMMDD')   and TS.TAX_INCLUSIVE_FLAG is not null THEN TS.TAX_INCLUSIVE_FLAG 
