...
where NOT EXISTS 
	( select 1 from ODS_STAGE_CA.FOW_RECORD_CHANGE_AUDIT T
...
BEGIN
               ...
               SELECT 'ODS_STAGE_CA.FOW_RECORD_CHANGE_AUDIT' INTO TargetTable FROM DUAL;
...
select	
	'ODS_STAGE_CA',
	'FOW_RCRD_CHG_AUD',
	'ODS_STAGE_CA.FOW_RECORD_CHANGE_AUDIT1726001',
	E.ODI_ERR_TYPE,
	E.ODI_ERR_MESS,
	E.ODI_CHECK_DATE,
	E.ODI_ORIGIN,
...
merge into	ODS_STAGE_CA.FOW_RECORD_CHANGE_AUDIT T
