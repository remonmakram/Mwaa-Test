...
/*-----------------------------------------------*/
/* TASK No. 18 */
/* insert into ods_stage.fow_offering_model_xr */
...
select
    Id,   
    ODS_STAGE.FOW_OFFERING_MODEL_OID_SEQ.nextval,
    SYSDATE
FROM (  
 Select  
     T.Id    
 From
     ODS_STAGE.Fow_Offering_Model_Stg T,
     ODS_STAGE.FOW_OFFERING_MODEL_XR XR
 Where (1=1)
...
from	ODS_OWN.SOURCE_SYSTEM   SOURCE_SYSTEM, ODS_STAGE.FOW_OFFERING_MODEL_STG   FOW_OFFERING_MODEL_STG, ODS_OWN.PRICE_PROGRAM   PRICE_PROGRAM, ODS_OWN.VISUAL_MERCH   VISUAL_MERCH, ODS_STAGE.FOW_OFFERING_MODEL_XR   OFFERING_MODEL_XR
where	(1=1)
