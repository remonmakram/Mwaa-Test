...
where NOT EXISTS 
	( select 1 from ODS_STAGE_CA.FOW_AUTO_ORDER_LINE_STG T
	where	T.ID	= S.ID 
...
select	
	...
	'ODS_STAGE_CA.FOW_AUTO_ORDER_LINE_STG',
	E.ODI_ERR_TYPE,
	E.ODI_ERR_MESS,
	E.ODI_CHECK_DATE,
	E.ODI_ORIGIN,
...
/* DETECTION_STRATEGY = NOT_EXISTS */
update	ODS_STAGE_CA.FOW_AUTO_ORDER_LINE_STG T
set 	
	(
	T.VERSION,
	T.ADDED_ON_EVENT,
...
/* DETECTION_STRATEGY = NOT_EXISTS */
insert into 	ODS_STAGE_CA.FOW_AUTO_ORDER_LINE_STG T
	(
	ID,
	VERSION,
	ADDED_ON_EVENT,
...
Merge Into ODS_STAGE_CA.FOW_AUTO_ORDER_LINE_XR T
Using (Select ID, OFFERING_ID From ODS_STAGE_CA.FOW_AUTO_ORDER_LINE_STG
...
S.ID,
S.OFFERING_ID,
ODS_STAGE_CA.AUTO_ORDER_LINE_OID_SEQ.nextval,
SYSDATE,
SYSDATE
)
...
from	ODS_STAGE_CA.FOW_AUTO_ORDER_LINE_STG   FOW_AUTO_ORDER_LINE_STG, ODS_OWN.SOURCE_SYSTEM   SOURCE_SYSTEM, ODS_STAGE_CA.FOW_AUTO_ORDER_LINE_XR   AUTO_ORDER_LINE_XR, ODS_OWN.OFFERING   OFFERING, ODS_STAGE_CA.FOW_OFFERING_XR   FOW_OFFERING_XR
where	(1=1)
...
using (
    ...
    from 
     ...
     , ODS_STAGE_CA.FOW_AUTO_ORDER_LINE_XR  F
     ,ODS_OWN.OFFERING  O
     ,ODS_STAGE_CA.FOW_OFFERING_XR xr
    where (1=1) 
