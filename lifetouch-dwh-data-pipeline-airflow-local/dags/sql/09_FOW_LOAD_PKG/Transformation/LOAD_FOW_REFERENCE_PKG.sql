...
where NOT EXISTS 
	( select 1 from ODS_STAGE.FOW_REFERENCE_STG T
	where	T.ID	= S.ID 
...
BEGIN
               ...
               SELECT 'ODS_STAGE.FOW_REFERENCE_STG' INTO TargetTable FROM DUAL;
...
select	
	'ODS_STAGE',
	'FOW_REFERENCE_STG',
	'ODS_STAGE.FOW_REFERENCE_STG1499001',
	E.ODI_ERR_TYPE,
	E.ODI_ERR_MESS,
	E.ODI_CHECK_DATE,
	E.ODI_ORIGIN,
...
merge into	ODS_STAGE.FOW_REFERENCE_STG T
