...
dag_config_file = "99_uc_lawson_refunds_pkg/99_uc_lawson_refunds_pkg_pipeline_config.yaml"
...
with DAG(
    ...
    export_data_to_s3 >> transformation_task_group >> deploy_files >> send_email
