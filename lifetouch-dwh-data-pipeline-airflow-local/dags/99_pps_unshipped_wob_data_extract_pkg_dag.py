...
dag_config_file = "99_pps_unshipped_wob_data_extract_pkg/99_pps_unshipped_wob_data_extract_pkg_pipeline_config.yaml"
...
with DAG(
    ...
    evaluate_branch = lt.check_branch(dag, task_group_config=task_groups[0])
    export_data_to_s3 = lt.export_data_to_s3(dag, task_group_config=task_groups[1])
    dummy_end = lt.dummy_end(dag)

    evaluate_branch >> [export_data_to_s3, dummy_end]
