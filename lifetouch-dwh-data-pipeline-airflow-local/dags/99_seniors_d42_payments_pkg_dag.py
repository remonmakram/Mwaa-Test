...
dag_config_file = "99_seniors_d42_payments_pkg/99_seniors_d42_payments_pkg_pipeline_config.yaml"
...
with DAG(
    ...
    send_email = lt.send_email(dag, task_groups[2])
    
    export_data_to_s3 >> transformation_task_group >> send_email
