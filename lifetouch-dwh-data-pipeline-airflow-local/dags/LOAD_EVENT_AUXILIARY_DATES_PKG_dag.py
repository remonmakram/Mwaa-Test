...
dag_config_file = "LOAD_EVENT_AUXILIARY_DATES_PKG/LOAD_EVENT_AUXILIARY_DATES_PKG_pipeline_config.yaml"
...
with DAG(
    ...
    # 6 times per day => every 4 hours => every 240 minutes
    # shfly_delay_sensor = lt.create_delay_sensor(delay_time=240)
