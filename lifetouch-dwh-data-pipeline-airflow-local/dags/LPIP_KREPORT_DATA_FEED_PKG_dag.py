...
dag_config_file = "LPIP_KREPORT_DATA_FEED_PKG/LPIP_KREPORT_DATA_FEED_PKG_pipeline_config.yaml"
...
with DAG(
    ...
    export_files_to_s3 = lt.export_data_to_s3(dag, task_groups[0])
    transformation_task_group_update = lt.transformation_task_group(dag, task_groups[1])

    export_files_to_s3 >> transformation_task_group_update
