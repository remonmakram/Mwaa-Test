...
dag_config_file = "60_LOAD_AGG_VOLUME_PKG/60_load_agg_volume_pipeline_config.yaml"
...
with DAG(
    ...
    send_email = lt.send_email(dag, task_groups[1])

    transformation_task_group >> send_email
