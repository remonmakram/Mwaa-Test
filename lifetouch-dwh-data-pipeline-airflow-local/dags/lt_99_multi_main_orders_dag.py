...
dag_config_file = "99_MULTI_MAIN_YB_ORDERS_PKG/99_multi_main_pipeline_config.yaml"
...
with DAG(
    ...
    send_email_1 = lt.send_email(dag, task_group_config=task_groups[2])

    send_email_2 = lt.send_email(dag, task_group_config=task_groups[3])
    
    drop_and_create >> deploy_files >> check_branch >> [send_email_1, send_email_2]